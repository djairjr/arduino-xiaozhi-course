...
-  It can run on any display without relying on a specific hardware platform
-  Configure clipable (minimum resource occupancy: 64 kB Flash, 16 kB RAM)
...
-  All written by C and support C++ calls
...
-  Detailed [documents] (http://docs.lvgl.io/) and API reference manuals, available for online viewing or downloadable in PDF format
...
### Style a Slider Sets the style of the slider
...
-  Introduce your works or projects designed based on LVGL
-  Write some routines
