...
#include "screen_settings_volume.h"
...
void setup_screen_settings(lv_screens_info *ui) {
    ...
    setup_settings_volume(ui);  // 创建音量设置页面
    ...
    lv_menu_set_load_page_event(ui->menu, ui->menu_main_page_label_volume, ui->menu_volume_page);
}
